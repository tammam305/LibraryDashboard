            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="card-header d-flex align-items-center" style="border-bottom-width: 8px ;padding-left: 100px;height: 83px;margin-bottom: 35px;padding-bottom: 10px;width: 1050px;">
                     ...
                     <table class="table table-striped" style="width:999px; height:px;">
                        <thead >
                          <tr style=" background-color:#2C3E50; color:white; width:400px; height: 30px;">
                            ...
                            <th style="padding-bottom: 20px;padding-left: 12px;"><strong>Tweet <span style=" color: red;"> [For help us, please select best tweets]</span></strong></th>
...
<!--
                      ...
                      <div class="card-body"style="padding-bottom: 20px;padding-top: 10px;">
                      <table class="table table-striped" style="width:999px; height:px; margin-top:0px;">
